...
async function main() {
 ...
 ...(drivers ?? []).map(
 (d) =>
 `${d.driver_code},${d.driver_code.toLowerCase()}@rkj.com,${d.full_name},DRIVER,HQ ke Kiosk,${DEFAULT_PASSWORD},Pemandu`
 ),
 ];
 fs.writeFileSync(
 ...
 console.log('\nContoh log masuk:');
 console.log(' Super Admin ke matisa@rkj.com');
 console.log(' Staf POS ke s001@rkj.com (ELSA, BR007)');
 console.log(' Pemandu ke d001@rkj.com (Samad)');
}
