...
const TEST_MATRIX = [
  ...
  { role: 'AREA_MANAGER', email: 'safuan@rkj.com', label: 'AM Utara', region: 'UTARA' },
  { role: 'AREA_MANAGER', email: 'hakim@rkj.com', label: 'AM Tengah', region: 'TENGAH' },
  { role: 'AREA_MANAGER', email: 'yati@rkj.com', label: 'AM Selatan', region: 'SELATAN' },
