...
/** Aliran rantaian bekalan: Kilang → Distributor → Jualan kiosk */
export const OWNER_SUPPLY_CHAIN = [
  ...
  { step: 4, label: 'Kiosk', sub: '36 cawangan', icon: Building2 },
  { step: 5, label: 'POS', sub: 'Jualan', icon: ShoppingCart },
] as const;
...
export const OWNER_COMPANY_BLOCKS: OwnerCompanyBlock[] = [
  {
    ...
    highlights: ['Production order', '9 item stok rasmi', 'Sahkan ke HQ'],
    departments: [
      {
        id: 'mfg-factory',
      ...
      {
        id: 'mfg-stock',
        label: 'Inventori Kilang',
        description: 'Baki bahan & roti di lokasi kilang',
        href: '/inventory',
        icon: Package,
      },
    ],
  },
  {
    ...
    scope: 'Pengedaran · logistik · 3 Pengurus Kawasan · HQ Distributor',
    workflowLabel: '② Pengedaran',
    step: 2,
    accent: {
    ...
    highlights: ['3 AM · 36 cawangan', 'Cross-dock HQ', '5 pemandu'],
    departments: [
      {
        id: 'dist-hq',
...
export const OWNER_GROUP_DEPARTMENTS: OwnerDepartment[] = [
  ...
  },
  {
    id: 'grp-payroll',
    label: 'Gaji & HR',
    description: 'Staf · gaji mingguan · profil HR',
    href: '/payroll',
    icon: Wallet,
  },
  {
