...
export function optimizeRouteStops(
 stops: RouteStopMeta[],
 options?: { currentLat?: number | null; currentLng?: number | null }): OptimizeRouteResult {
 if (!stops.length) {
 return {
 orderedKeys: [],
