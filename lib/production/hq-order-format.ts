/**
 * Format borang order HQ ke Kilang (9 item rasmi, 3 seksyen).
 */
...
export const HQ_FACTORY_ORDER_SECTIONS: HqOrderSectionDef[] = [
 ...
 id: 'roti',
 number: 1,
 title: 'Produk Buatan Kilang - Roti',
 subtitle: 'RKJ Manufacturing hasilkan roti sendiri. Isi kuantiti dalam BAG - sistem auto kira pcs ikut menu',
 itemCodes: ['ST-PLANTA', 'ST-KELAPA', 'ST-KACANG', 'ST-BENGGALI'],
 },
 {
 id: 'bahan',
 number: 2,
 title: 'Kaya Buatan Kilang & Butter Supplier',
 subtitle: 'Kaya ikut production date; Butter ialah stok supplier/simpanan kilang. Isi kuantiti dalam TONG',
 ...
 subtitle: 'Stok pembungkusan dibeli daripada supplier sebagai simpanan operasi. Isi kuantiti dalam BAG',
