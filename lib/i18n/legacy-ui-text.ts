...
const enText: Record<string, string> = {
  ...
  Tambah: "Add",
  Hantar: "Submit",
  "Segar Semula": "Refresh",
  Penyelenggaraan: "Maintenance",
  "Pengurus Penyelenggaraan": "Maintenance Manager",
  Cari: "Search",
  Status: "Status",
  Tindakan: "Actions",
  Ringkasan: "Summary",
  ...
  "POS - Kaunter Tunai": "POS - Cash Counter",
  ...
  "Sila pilih tarikh mula cuti.": "Please select the leave start date.",
  "Sila pilih cawangan untuk melihat inventori kiosk dalam kawasan anda.":
    "Please select a branch to view kiosk inventory in your area.",
  "Sila pilih cawangan dari senarai di atas untuk melihat data modul ini.":
    "Please select a branch from the list above to view this module data.",
  "Sila pilih cawangan untuk melihat jadual shift dan kehadiran.":
    "Please select a branch to view the shift schedule and attendance.",
  "Sila pilih fail dan isi tempoh slip":
    "Please select a file and enter the slip period",
  "Sila isi nota sebab beza tunai sebelum tutup syif":
    "Please enter the cash difference reason note before closing the shift",
  "Wajib pilih request barang cawangan yang sudah diluluskan.":
    "You must select an approved branch supply request.",
  "Gunakan jika urusan tidak termasuk dalam kategori di atas.":
    "Use this if the matter is not included in the categories above.",
  "Isi maklumat dengan jelas dan pilih tarikh jika berkaitan. HR akan proses ikut majikan legal dan cawangan anda.":
    "Enter the information clearly and select a date if relevant. HR will process it according to your legal employer and branch.",
  "Tiada lokasi untuk tapisan ini. Cuba pilih jenis lokasi lain.":
    "No locations match this filter. Try selecting another location type.",
  "Satu aliran kerja untuk HR: pilih syarikat, semak kadar staf, preview slip, jana payroll dan hantar untuk kelulusan.":
    "One HR workflow: select company, review staff rates, preview slips, generate payroll and submit for approval.",
  "Stok masuk/keluar dikawal HQ & Pengurus Kawasan. Gunakan tab Reject Stok di POS untuk lapor barang rosak.":
    "Stock in/out is controlled by HQ & Area Managers. Use the Reject Stock tab in POS to report damaged goods.",
  "Pindahan cawangan hanya antara kiosk - pilih cawangan asal dan destinasi":
    "Branch transfers are only between kiosks - select the source and destination branches",
  "Pengurus Kawasan mesti pilih cawangan kiosk":
    "Area Managers must select a kiosk branch",
  "Pilih driver di bawah atau tambah catatan area manual":
    "Select a driver below or add a manual area note",
  "Gabungkan DO, pilih driver, susun hentian, kemudian pantau status keluar, sampai dan POD.":
    "Combine DOs, select drivers, arrange stops, then monitor departure, arrival and POD status.",
  "Naikkan hanya isu kawasan yang perlukan keputusan lebih tinggi: cash tertunggak, driver gagal, permit atau disiplin.":
    "Escalate only area issues that need higher decisions: outstanding cash, failed drivers, permits or discipline.",
  "Ejen buat order, pilih pickup point, atau Ejen Khas order tanpa bayaran.":
    "Agents place orders, select pickup points, or Special Agents place orders without payment.",
  "Collection, cash usage voucher, slip bank-in dan baki tunai.":
    "Collection, cash usage vouchers, bank-in slips and cash balance.",
  "Jika tunai tidak seimbang atau refund besar, naik kepada owner.":
    "If cash is unbalanced or the refund is large, escalate it to the owner.",
  "Penyelarasan Tunai": "Cash Reconciliation",
  "Tunai / QR": "Cash / QR",
...
const msText: Record<string, string> = Object.entries(enText).reduce(
  ...
  },
  {
    ...
    "Owner Command Center": "Pusat Kawalan Pemilik",
    "Owner Control Center": "Pusat Kawalan Pemilik",
    ...
    "Exception & SLA Center": "Pusat Pengecualian & SLA",
    ...
    "Owner Management Control": "Kawalan Pengurusan Pemilik",
    "Management Control": "Kawalan Pengurusan",
    "Logistics Command Center": "Pusat Kawalan Logistik",
    "Production Readiness Center": "Pusat Kesiapan Production",
    "System Health Center": "Pusat Kesihatan Sistem",
    "Launch Control & UAT Owner": "Kawalan Pelancaran & UAT Pemilik",
    "Staff Login": "Log Masuk Pengguna",
    "Driver, route & POD": "Pemandu, laluan & POD",
    "RKJ Group": "Kumpulan RKJ",
    "Kelulusan & Exception Center": "Pusat Kelulusan & Pengecualian",
    "Kawalan Pengurusan Owner": "Kawalan Pengurusan Pemilik",
    "Delegation Matrix Owner": "Matriks Delegasi Pemilik",
    "Bank-grade Control": "Kawalan Bertaraf Bank",
    "Control Guardrail": "Had Kawalan Operasi",
    "Active requests": "Permohonan Aktif",
    "HRMIS Summary": "Ringkasan HRMIS",
    "Request History": "Sejarah Permohonan",
    "Active employer": "Majikan Aktif",
    "Pending request": "Permohonan Menunggu",
    "Profile & Documents": "Profil & Dokumen",
    "Document Control Syarikat": "Kawalan Dokumen Syarikat",
    "Susun Laluan Driver": "Susun Laluan Pemandu",
    "Driver Instructions": "Arahan Pemandu",
    "Driver Profile": "Profil Pemandu",
    "Active Drivers": "Pemandu Aktif",
    "Active Vehicles": "Kenderaan Aktif",
    "Active POS Outlets": "Outlet POS Aktif",
    "Pending Payment Orders": "Order Menunggu Bayaran",
    "Price Group": "Kumpulan Harga",
    "Group rate": "Kadar Kumpulan",
    "Group Rate": "Kadar Kumpulan",
    "Shift roster": "Jadual Syif",
    Staff: "Staf",
    Branches: "Cawangan",
    Branch: "Cawangan",
    Company: "Syarikat",
    ...
    "Manager Maintenance": "Pengurus Penyelenggaraan",
    "Branch Maintenance": "Penyelenggaraan Cawangan",
    "Maintenance Tickets": "Tiket Penyelenggaraan",
    "Maintenance Report": "Laporan Penyelenggaraan",
...
const patterns: Array<[RegExp, (...matches: string[]) => string]> = [
  ...
  [/^Minggu (.+)$/i, (value) => `Week ${translateLegacyUiText(value, "en")}`],
  ...
  [
    /^Sila (.+)$/i,
    (action) => `Please ${translateLegacyUiText(action, "en").toLowerCase()}`,
  ],
  [
    /^Wajib (.+)$/i,
    (action) => `Must ${translateLegacyUiText(action, "en").toLowerCase()}`,
  ],
  [
    /^Cari (.+)$/i,
...
const enFallbackPhrases: Array<[string, string]> = [
  ...
  ["bahan mentah", "raw materials"],
  ["staf jualan", "sales staff"],
  ["pekerja tempatan", "local employee"],
  ["pekerja local", "local employee"],
  ["pekerja asing", "foreign worker"],
  ["staf tempatan", "local staff"],
  ["staf aktif", "active staff"],
  ["rekod staf", "staff record"],
  ["rekod HR", "HR record"],
  ["profil pekerja", "employee profile"],
  ["profil HR", "HR profile"],
  ["permohonan HR", "HR request"],
  ["HRMIS kendiri", "self-service HRMIS"],
  ["baki cuti", "leave balance"],
  ["cuti tahunan", "annual leave"],
  ["cuti sakit", "sick leave"],
  ["cuti pending", "pending leave"],
  ["cuti digunakan", "leave used"],
  ["pelepasan kerja", "work release"],
  ["maklumat waris", "next-of-kin information"],
  ["majikan legal", "legal employer"],
  ["syarikat majikan", "employer company"],
  ["tahap akses", "access level"],
  ["akses ejen", "agent access"],
  ["lokasi inventory kiosk", "kiosk inventory location"],
  ["lokasi kiosk", "kiosk location"],
  ["inventory kiosk", "kiosk inventory"],
  ["inventori kiosk", "kiosk inventory"],
  ["stok kiosk", "kiosk stock"],
  ["kaunter POS", "POS counter"],
  ["buka syif", "open shift"],
  ["tutup syif", "close shift"],
  ["keluar kiosk", "away from the kiosk"],
  ["teruskan jualan", "continue sales"],
  ["tahun cuti", "leave year"],
  ["nilai cuti", "leave value"],
  ["kutipan tunai", "cash collection"],
  ["penggunaan cash", "cash usage"],
  ["baki bersih", "net balance"],
  ["barang cawangan", "branch supplies"],
  ["request barang cawangan", "branch supply request"],
  ["pembersihan mendalam", "deep cleaning"],
  ["jadual pembersihan", "cleaning schedule"],
  ["jadual delivery", "delivery schedule"],
  ["jadual syif", "shift schedule"],
  ["masa kerja", "working hours"],
  ["cawangan bermasalah", "problem branches"],
  ["kehadiran staf", "staff attendance"],
  ["staf hadir", "staff present"],
  ["status kerja", "work status"],
  ["tiket baru", "new tickets"],
  ["peralatan kiosk", "kiosk equipment"],
  ["minggu semasa", "current week"],
  ["pengurus cawangan", "branch manager"],
  ["prestasi syarikat", "company performance"],
  ["keputusan strategik", "strategic decisions"],
  ["isu kritikal", "critical issues"],
  ["tidak sah", "invalid"],
  ["tiada lokasi", "no locations"],
  ["tiada stok", "no stock"],
  ["sila pilih", "please select"],
  ["sila isi", "please enter"],
  ["wajib pilih", "must select"],
  ["tidak sepadan", "does not match"],
  ...
  ["belum disediakan", "not configured"],
  ["belum didaftarkan", "not registered"],
  ["belum dipautkan", "not linked"],
  ["belum ditetap", "not set"],
  ["di bawah", "below"],
  ["di atas", "above"],
  ["aliran kerja", "workflow"],
  ["cash tertunggak", "outstanding cash"],
  ["baki tunai", "cash balance"],
  ["barang rosak", "damaged goods"],
  ["tarikh mula", "start date"],
  ["tamat tempoh", "expiry"],
  ["dalam kategori", "in the category"],
  ["dalam kawasan", "in the area"],
  ["dalam senarai", "in the list"],
  ["dalam perjalanan", "in transit"],
  ["Ejen Khas", "Special Agent"],
  ["ejen khas", "special agent"],
...
const msFallbackPhrases: Array<[string, string]> = [
  ...
  ["local employee", "pekerja tempatan"],
  ["foreign worker", "pekerja asing"],
  ["local staff", "staf tempatan"],
  ["active staff", "staf aktif"],
  ["staff record", "rekod staf"],
  ["HR record", "rekod HR"],
  ["employee profile", "profil pekerja"],
  ["HR profile", "profil HR"],
  ["HR request", "permohonan HR"],
  ["self-service HRMIS", "HRMIS kendiri"],
  ["leave balance", "baki cuti"],
  ["annual leave", "cuti tahunan"],
  ["sick leave", "cuti sakit"],
  ["pending leave", "cuti pending"],
  ["leave used", "cuti digunakan"],
  ["work release", "pelepasan kerja"],
  ["next-of-kin information", "maklumat waris"],
  ["legal employer", "majikan legal"],
  ["employer company", "syarikat majikan"],
  ["access level", "tahap akses"],
  ["agent access", "akses ejen"],
  ["kiosk inventory location", "lokasi inventory kiosk"],
  ["kiosk location", "lokasi kiosk"],
  ["kiosk inventory", "inventori kiosk"],
  ["kiosk stock", "stok kiosk"],
  ["POS counter", "kaunter POS"],
  ["open shift", "buka syif"],
  ["close shift", "tutup syif"],
  ["away from the kiosk", "keluar kiosk"],
  ["continue sales", "teruskan jualan"],
  ["leave year", "tahun cuti"],
  ["leave value", "nilai cuti"],
  ["cash collection", "kutipan tunai"],
  ["cash usage", "penggunaan cash"],
  ["net balance", "baki bersih"],
  ["branch supplies", "barang cawangan"],
  ["branch supply request", "request barang cawangan"],
  ["deep cleaning", "pembersihan mendalam"],
  ["cleaning schedule", "jadual pembersihan"],
  ["delivery schedule", "jadual delivery"],
  ["shift schedule", "jadual syif"],
  ["working hours", "masa kerja"],
  ["problem branches", "cawangan bermasalah"],
  ["staff attendance", "kehadiran staf"],
  ["staff present", "staf hadir"],
  ["work status", "status kerja"],
  ["new tickets", "tiket baru"],
  ["kiosk equipment", "peralatan kiosk"],
  ["current week", "minggu semasa"],
  ["branch manager", "pengurus cawangan"],
  ["company performance", "prestasi syarikat"],
  ["strategic decisions", "keputusan strategik"],
  ["critical issues", "isu kritikal"],
  ...
  ["Failed to", "Gagal"],
  ["Invalid", "Tidak sah"],
  ["Not applicable", "Tidak terpakai"],
  ["Incomplete", "Tidak lengkap"],
  ["Configured", "Disediakan"],
