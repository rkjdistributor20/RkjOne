...
<head>
 ...
 <style>
 body { font-family: 'Segoe UI', Arial, sans-serif; max-width: 720px; margin: 0 auto; padding: 32px; color: #111; }.header { border-bottom: 3px solid #ea580c; padding-bottom: 16px; margin-bottom: 24px; }.brand { font-size: 22px; font-weight: 700; color: #ea580c; }.meta { font-size: 13px; color: #666; margin-top: 4px; }
 h2 { font-size: 16px; margin: 24px 0 8px; }
 table { width: 100%; border-collapse: collapse; font-size: 14px; }.total { border-top: 2px solid #111; font-size: 16px; }.footer { margin-top: 32px; font-size: 11px; color: #888; border-top: 1px solid #ddd; padding-top: 12px; }
