...
export function AgentPaymentDialog({
 ...
 <>
 Bayaran dihantar ke <strong>Maybank RKJ Distributor Sdn Bhd</strong> melalui gateway bayaran rasmi (FPX / kad kredit / kad debit). Tempahan stok atau langganan POS hanya disahkan
 selepas bank mengesahkan bayaran.
 </>) : (
 <>
 <strong>Mod pilot:</strong> Payment gateway belum diaktifkan - bayaran ujian disahkan dalam
 sistem. Selepas credential merchant diset, bayaran sebenar ke Maybank RKJ
