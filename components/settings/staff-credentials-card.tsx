  ...
  return (
    ...
    >
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center justify-between gap-2 rounded-md border bg-white px-3 py-2">
          <div className="min-w-0">
            <p className="text-[10px] uppercase text-muted-foreground">Kata Laluan Semasa</p>
      ...
      <p className="text-xs text-muted-foreground">
        Kongsi kredensial ini kepada staf. Staf akan diarah tukar kata laluan pada log masuk
        pertama.
      </p>
    </div>
  );
