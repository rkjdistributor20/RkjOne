  ...
  return (
    <div className="mx-auto max-w-2xl space-y-4">
      ...
      <Card>
        ...
        <CardContent className="space-y-3 text-sm">
          ...
          <p className="text-xs text-muted-foreground">
            Contoh: reject 0.5 tong Kaya → 2,500 g ditolak · reject 2 bag Plastic M → 200 pcs
            ditolak · reject 1 bag Roti Kaya → 20 pcs ditolak
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          {loading ? (
            <p className="text-sm text-muted-foreground">Memuatkan item stok…</p>
          ) : stockItems.length === 0 ? (
