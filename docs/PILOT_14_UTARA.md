...
**Selepas pilot lulus:** rollout Tengah (Hakim, 10) → Selatan (Yati, 14)

Password sementara (tukar selepas hari 1): `RkjOne@2025`
...
| **HQ Operasi** | Ibrahim | HQ Distributor → delivery → kiosk Utara |
...
```
Kilang → HQ Distributor → Fleet → Kiosk Utara → POS
```
...
- [ ] Safuan: jadual staf mingguan diterbitkan (Syif → Jadual Mingguan)

### Hari 4–10 (operasi penuh)

- [ ] POS harian semua 12 cawangan (buka → jual → tutup syif)
...
5. Baki stok turun · cuba jual melebihi stok → sistem halang  
