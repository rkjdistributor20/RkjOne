...
| M6.5 | Done | Owner/DevOps AI | Deploy production. | Production deployment `dpl_55k1i1FNbsmaMnEHwfHkpj41yKQJ` is Ready, aliased to `https://rkj-one.vercel.app`, and runtime error check is clean. |
