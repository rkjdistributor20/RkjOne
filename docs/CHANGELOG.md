...
- Corrected the post-enrollment staff sign-in handoff to use a fresh document navigation, preventing the protected POS layout from reusing a stale unauthenticated route state.
