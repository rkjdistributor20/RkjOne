...
insert into rkj_products (sku,name,category,price,sale_unit,status,notes) values ('BENG-KB','Roti Benggali - Kaya Butter','Benggali',12.5,'Pcs','Active','Banner menu') on conflict (sku) do update set name=excluded.name, price=excluded.price, status=excluded.status;
insert into rkj_products (sku,name,category,price,sale_unit,status,notes) values ('BENG-KO','Roti Benggali - Kaya Only','Benggali',9.0,'Pcs','Active','Banner menu') on conflict (sku) do update set name=excluded.name, price=excluded.price, status=excluded.status;
insert into rkj_products (sku,name,category,price,sale_unit,status,notes) values ('BENG-PL','Roti Benggali - Plain','Benggali',7.0,'Pcs','Active','Banner menu') on conflict (sku) do update set name=excluded.name, price=excluded.price, status=excluded.status;
insert into rkj_products (sku,name,category,price,sale_unit,status,notes) values ('KAYA-CUP','Kaya In Cup','Benggali',5.0,'Cup','Active','Banner menu') on conflict (sku) do update set name=excluded.name, price=excluded.price, status=excluded.status;

-- Stock items
insert into rkj_stock_items (item_code,name,category,storage_unit,conversion_text,min_threshold,critical_threshold,status,notes) values ('ST-PLANTA','Roti Planta','Roti','Bag/Pcs','1 Bag = 20 pcs',NULL,NULL,'Active','Diguna untuk menu Roti Kaya') on conflict (item_code) do update set name=excluded.name, conversion_text=excluded.conversion_text;
insert into rkj_stock_items (item_code,name,category,storage_unit,conversion_text,min_threshold,critical_threshold,status,notes) values ('ST-KELAPA','Roti Kelapa','Roti','Bag/Pcs','1 Bag = 28 pcs',NULL,NULL,'Active',NULL) on conflict (item_code) do update set name=excluded.name, conversion_text=excluded.conversion_text;
insert into rkj_stock_items (item_code,name,category,storage_unit,conversion_text,min_threshold,critical_threshold,status,notes) values ('ST-KACANG','Roti Kacang','Roti','Bag/Pcs','1 Bag = 24 pcs',NULL,NULL,'Active',NULL) on conflict (item_code) do update set name=excluded.name, conversion_text=excluded.conversion_text;
insert into rkj_stock_items (item_code,name,category,storage_unit,conversion_text,min_threshold,critical_threshold,status,notes) values ('ST-BENGGALI','Roti Benggali','Roti','Bag/Pcs','1 Bag = 2 pcs',NULL,NULL,'Active',NULL) on conflict (item_code) do update set name=excluded.name, conversion_text=excluded.conversion_text;
